...
CREATE TABLE `IncidentCoverageType` (
  `IncCoverageID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ChannelUserDetails` (
  `ChannelUserDetailsID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ChannelUserIncidentAndLocation` (
  `ChannelUserIncAndLocID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ChannelUserLocationReport` (
  `UserLocRptID` bigint(20) DEFAULT NULL AUTO_INCREMENT,
...
CREATE TABLE `ChannelUserIncidentReport` (
  `UserIncRptID` bigint(20) NOT NULL AUTO_INCREMENT,
